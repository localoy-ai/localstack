...
`.brain/put/lead-<canonical-domain>.md` per shipped row, first line
`type: lead`, then the body above verbatim; the daemon stores them after
the turn. Neither the CLI nor `.brain/` → skip and add one line to the
